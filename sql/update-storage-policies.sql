-- Update Supabase Storage Policies for Profile Photos
-- This script safely drops existing policies and creates new ones
...
-- Create new storage policies for the profile-photos bucket
...
DROP FUNCTION IF EXISTS get_user_photo_count(UUID);
DROP FUNCTION IF EXISTS validate_photo_upload();
